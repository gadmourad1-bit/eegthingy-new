...
Run:  python -m deepnet.external_benchmark --subjects 1-20 --archs geoadapt,eegnet,shallow,deep,conformer,atcnet \
        --folds 5 --seeds 7 --device cuda --output deepnet/results/dnn_compare_cho2017.json
"""
