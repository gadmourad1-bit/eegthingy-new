...
Run:  python -m deepnet.dnn_benchmark --archs geoadapt,eegnet,shallow,deep,conformer,atcnet \
        --seeds 7,17,27 --device cuda --output deepnet/results/dnn_compare_local.json
"""
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--output", type=Path, default=PROJECT_ROOT / "deepnet" / "results" / "dnn_compare_local.json"
    )
