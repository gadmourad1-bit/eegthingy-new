...
import deepnet.orbit_transport_benchmark as benchmark
from deepnet.orbit_transport_net import OrbitTransportConfig, OrbitTransportOutput
...
def test_source_manifest_covers_all_loaded_first_party_dependencies() -> None:
    assert {
        ...
        "deepnet/cameo_benchmark.py",
        "deepnet/parity_fuse_benchmark.py",
        "deepnet/parity_fuse_net.py",
        "deepnet/augment.py",
        "deepnet/config.py",
        "deepnet/data.py",
        "deepnet/external_cho2017.py",
...
def test_frozen_manifest_pins_orbit_source_dev_file_and_summary(
    ...
    source = {
        "deepnet/orbit_transport_net.py": "1" * 64,
        "deepnet/orbit_transport_benchmark.py": "2" * 64,
    }
...
def test_empty_development_records_cannot_be_frozen(
    ...
    source = {"deepnet/orbit_transport_net.py": "1" * 64}
    monkeypatch.setattr(benchmark, "_source_manifest", lambda: source)
    monkeypatch.setattr(
