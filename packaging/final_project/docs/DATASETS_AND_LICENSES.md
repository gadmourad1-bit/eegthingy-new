...
[`ieee_mi/config.py`](../ieee_mi/config.py)
...
The common public-dataset cache contract is `ieee-mi-cache-v2`: 4-40 Hz,
...
[`dataset specification`](../ieee_mi/config.py) and
[`manuscript submission notes`](../paper/README.md), reviewed 2026-07-29.
...
hand movements,” *IEEE Transactions on Neural Systems and Rehabilitation
Engineering* (2007),
