...
from ieee_mi import native_transfer as transfer
from ieee_mi import native_transfer_audit as audit
    ...
    *,
    ...
    provenance = {
        ...
        "source_code": {
            ...
            "files": {"ieee_mi/native_transfer.py": hashlib.sha256(b"source").hexdigest()},
        },
    }
