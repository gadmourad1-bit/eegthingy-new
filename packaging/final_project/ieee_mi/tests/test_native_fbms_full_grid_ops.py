...
from ieee_mi import native_fbms_full_grid_ops as ops
from ieee_mi import native_transfer_audit as audit_core
                ...
                json.dumps(
                    {
                        "target": {
                            "cache_path": (
                                f"/historical/eegthingy/data_cache/ieee-mi-cache-v2/"
...
def test_source_manifest_is_exact_and_rejects_optional_extra(
    ...
    assert (
        ops.PINNED_SOURCE_MANIFEST["ieee_mi/native_fbms_transfer.py"]
...
def test_pinned_record_validation_rejects_stale_corpus_and_manifest(
    ...
    stale_manifest["ieee_mi/native_fbms_transfer.py"] = "0" * 64
