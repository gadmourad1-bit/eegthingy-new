...
``ieee_mi.local_model_tournament.ARCHITECTURES``.  Procedure-only and classical
...
COMMON_RESULT = (
    ...
    "(ieee_mi/results/local_exp4_allmodels_20260721/neural/final_ranking.json)"
)
...
_COMMON_IN_HOUSE: tuple[ModelRecord, ...] = (
    ...
    _common_in_house(
        ...
        "CardinalField",
        "distinct_architecture",
        "ieee_mi.models.CardinalFieldNet",
        "raw EEG plus electrode coordinates",
    ...
    _common_in_house(
        ...
        "CardinalField",
        "family_configuration",
        "ieee_mi.models.FreeCardinalFieldNet",
        "raw EEG in a fixed channel order",
    ...
    _common_in_house(
        ...
        "CardinalDynamics",
        "distinct_architecture",
        "ieee_mi.models.CardinalDynamicsNet",
        "raw EEG plus electrode coordinates",
    ...
    _common_in_house(
        ...
        "CardinalFBC",
        "family_configuration",
        "ieee_mi.models.CardinalFBCCorrelationNet",
        "raw EEG plus electrode coordinates",
    ...
    _common_in_house(
        ...
        "CardinalFBC",
        "family_configuration",
        "ieee_mi.models.CardinalFBCCompactDynamicsNet",
        "raw EEG plus electrode coordinates",
    ...
    _common_in_house(
        ...
        "CardinalFBC",
        "family_configuration",
        "ieee_mi.models.CardinalFBCMicroDynamicsNet",
        "raw EEG plus electrode coordinates",
    ...
    _common_in_house(
        ...
        "CardinalFBC",
        "family_configuration",
        "ieee_mi.models.CardinalFBCPhysicalDynamicsNet",
        "raw EEG plus electrode coordinates",
    ...
    _common_in_house(
        ...
        "CardinalFBMS",
        "distinct_architecture",
        "ieee_mi.models.CardinalFBMSNet",
        "raw EEG plus electrode coordinates",
    ...
    _common_in_house(
        ...
        "CardinalMixedTemporal",
        "distinct_architecture",
        "ieee_mi.models.CardinalMixedTemporalNet",
        "raw EEG plus electrode coordinates",
...
_ADDITIONAL_ARCHITECTURES: tuple[ModelRecord, ...] = (
    ModelRecord(
        ...
        existing_result_coverage=(
            "local_exp4 and Cho2017 architecture/deployment artifacts in deepnet/results",
        ),
    ...
    ModelRecord(
        ...
        "linear head.",
        existing_result_coverage=(
            "local_exp4 and Cho2017 diagnostic artifacts in deepnet/results",
        ),
        documentation_link="docs/MODEL_REGISTRY.md#geoadaptnet-family",
        citation=(
    ...
    ModelRecord(
        ...
        existing_result_coverage=(
            "Cho2017 30-subject diagnostic artifact in deepnet/results/dev",
        ),
        documentation_link="docs/MODEL_REGISTRY.md#geoadaptnet-family",
        source_pin="repository source hashes are captured in result artifacts",
        license="project license not declared in repository",
    ...
    ModelRecord(
        ...
        ownership="in_house",
        track="procedure",
        implementation="deepnet.cameo_net.CAMEOClassifier",
    ...
    ModelRecord(
        ...
        ownership="in_house",
        track="procedure",
        implementation="deepnet.parity_net.HemiParityClassifier",
    ...
    ModelRecord(
        ...
        ownership="in_house",
        track="procedure",
        implementation="deepnet.parity_fuse_net.ParityFuseClassifier",
        input_representation="paired raw/reflected EEG plus paired SPD tangent features",
        class_support="binary",
        dataset_eligibility=_BINARY_FOUR,
    ...
    ModelRecord(
        ...
        ownership="in_house",
        track="procedure",
        implementation="ieee_mi.dual_view.CardinalSplineDualViewNet",
...
def _orbit_record(
    ...
    return ModelRecord(
        ...
        ownership="in_house",
        track="procedure",
        implementation="deepnet.orbit_transport_net.OrbitTransportClassifier",
...
_CLASSICAL_CONTROLS: tuple[ModelRecord, ...] = (
    _control_record(
        ...
        "deepnet.baselines.RiemannianTangentLogistic",
    ...
    _control_record(
        ...
        "deepnet.tangent_anchor.TangentAnchorClassifier",
        "four-band SPD covariance tensors",
    ...
    _control_record(
        "ea_fbcsp",
        "EA-FBCSP",
        "deepnet.baselines.EAFilterBankCSP",
