...
ARTIFACT_SCHEMA = "ieee-mi-native-pretraining-development-v1"
CHECKPOINT_SCHEMA = "ieee-mi-native-pretraining-checkpoint-v1"
...
def _source_paths(
    ...
    paths = {
        ...
        "ieee_mi/native_pretraining_cli.py": Path(__file__).resolve(),
