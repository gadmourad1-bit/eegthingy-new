...
> **Chronological namespace record.** Most entries below predate the public
> namespace cleanup. `pre-migration-package/` is a token-free display alias
> for the predecessor package in those historical path records; it is not a
> literal filesystem path. The hashes still identify the predecessor bytes,
> not files at the display alias or their sanitized reissues. Later entries
> record successive namespace migrations; the current local source layout is
> documented separately in `PROJECT_STRUCTURE.md`.
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/project_gpu_leases.py` | `b0d12a8689430c00984bc4fe95800ee626cb37f20434b578591b3d26f0d91908` |
| `pre-migration-package/tests/test_project_gpu_leases.py` | `43a509eb90907cbb1b07b691caad2787de50e2f31c6ae6e4a0afed2f0fb31b26` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/procedure_grid.py` | `256e56b93c9c261c6f9f9954e3e3599f3dd8b42f4d729c7e678b5d69e8de6205` |
| `pre-migration-package/procedure_grid_analysis.py` | `36a45b85c8d4f6060d2554363fcac5541d97b9ee5698b4702c61173ffde916cc` |
| `pre-migration-package/tests/test_procedure_grid.py` | `6927159622148226867485d8fa231731c7b207d838bf23fab70a1b54ad3d92c4` |
| `pre-migration-package/tests/test_procedure_grid_analysis.py` | `9c5b0e2d8582f23192158542ba493821dbf13d87365a357462f35a69a4e621e5` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/procedure_grid.py` | `2ef83e67b025936a46bf3a9c0f668c6f772dce01be8c9834b0971632e60c1617` |
| `pre-migration-package/procedure_grid_analysis.py` | `9ab89f07b232290bc646b156f66c9e8c8275892b744a0e165ad79f0892f0492e` |
| `pre-migration-package/tests/test_procedure_grid.py` | `23d929b9ff31507523c9b864ab9ff9e091b62c16c259d8210dbaf36cc5836bd0` |
| `pre-migration-package/tests/test_procedure_grid_analysis.py` | `8bc2b534d8cc96346f293e426e4425f457d6df60a27eb9648dde3805e1c243c6` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/geoadapt_v2.py` | `cd13a2d6a1a4e96234f6389d99e71b46f2b209af05b6edaff16e163feb873943` |
| `pre-migration-package/geoadapt_v2_analysis.py` | `44164be459fdc106b022f78b6f414c9449537639ed258a668958777c9de73b88` |
| `pre-migration-package/tests/test_geoadapt_v2.py` | `a7d1de57bbc45bbc4edebbe49ab9d13fca5f2762cd47e6f4e0ec9aee1c2f9b7b` |
| `pre-migration-package/data.py` | `280c6bb51d02ff8d57fefa77abd5e4e11960593558dbd13867134fe0df3c9fac` |
| `pre-migration-package/tests/test_data.py` | `68860a599e04176a7b5aeaae586d50879d249f21867e95e8086047d28932bb83` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/geoadapt_v2.py` | `b61c0bb79330f56304e5953c6106e0626d8d7e8dd789b8b0c6c4d567677d9fef` |
| `pre-migration-package/geoadapt_v2_analysis.py` | `7f370f42d8fd6b1476b7d2a472e89eff333fb26e8dde5712b5815027d2232203` |
| `pre-migration-package/tests/test_geoadapt_v2.py` | `b95133a49f38fb2c76db66f4f1bab35f7dc29b29b121447624b79edbd1cebc5a` |
...
|---|---|
| `pre-migration-package/geoadapt_v2.py` | `b61c0bb79330f56304e5953c6106e0626d8d7e8dd789b8b0c6c4d567677d9fef` |
| `pre-migration-package/geoadapt_v2_analysis.py` | `a8d38aa80dd13a0bc479e45e99ca16736d3bd8c577ddfd39aa198cd189785fd9` |
| `pre-migration-package/tests/test_geoadapt_v2.py` | `f87524f403ae06682bfa952cb4d450af4e6c3da9be59841707584c40fa0c5c98` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/geoadapt_v2.py` | `1dcb104184370e8083b1c116c9124375f57949cdca2ff06ac617d57a888d3564` |
| `pre-migration-package/geoadapt_v2_analysis.py` | `e7ab42a5ea7bda56ecd9e913b2760e5eeb381866f6d1dbef9e67a32f72f26eec` |
| `pre-migration-package/tests/test_geoadapt_v2.py` | `0735a5e9cf72306197b87265adf598cdeb65200a22e6e70a67f4fad2e665b977` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `a94c9bfec8ff35687615d0f4a45c61757e9bcfba926d5d68362c9a15ffd69897` |
| `pre-migration-package/full_grid_analysis.py` | `5017a51af2bd0a86a2ae1e62599b8d70d0a288146b355bd2b4b3484e42467711` |
| `pre-migration-package/baselines.py` | `a31f0891484f3db3e23b0b11727045b98cc0d2ae2099b7499d1e6ed6858ead88` |
| `pre-migration-package/tcformer_source.py` | `140960093538f163083bbe84a76f7fe9681b40c0f4a1be74246e964af4e2534e` |
| `pre-migration-package/tests/test_full_grid.py` | `b48fa2fa2f3974da3c13aac9e45610d23256d8d94730d974454740a4db989cd9` |
| `pre-migration-package/tests/test_full_grid_analysis.py` | `41596767779dab82b0dfd83545131712c630cd810443f4867771e86958273271` |
| `pre-migration-package/tests/test_tcformer_source.py` | `f125f87d2781bf1e85a7c7fb888f3ade97f0550116035418385aa77cd6c9a99b` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/data.py` | `6dfc3be77f315c60acb1aa26c2e2ca70a11e9480390646e351f55429100ad4aa` |
| `pre-migration-package/full_grid.py` | `121e26bdfd27af633a87b7c664ee13ae592fff770a36a2f2e2282b450ef70e92` |
| `pre-migration-package/full_grid_analysis.py` | `e6e81194ae92816b55196d930a72c70dd5635bbac429cea4c5c11200f3be5b5b` |
| `pre-migration-package/tests/test_data.py` | `978d812c55ec0a6618fe75182cf36649acb10a6247db7882a6cdfb9205ead180` |
| `pre-migration-package/tests/test_full_grid.py` | `59d0bc9b4d5339034f6f92e883506ab49d7f677b412a0e48112b3f4986da570c` |
| `pre-migration-package/tests/test_full_grid_analysis.py` | `88dcae299f2d7afa9732e3a621ef6996b99a1ceb713dddf76bb9b0ff3263efdb` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `67e25f47bafeb29d57ded5cc0fa6581dcef12cfccfa1d20c13a90649c304ff36` |
| `pre-migration-package/full_grid_analysis.py` | `bcacbf8c8b36e0ea353e690bece38eabc8712c288b0d553a940dbf68d8a22e40` |
| `pre-migration-package/tests/test_full_grid.py` | `54604c287b93520f4e0235e96d47ef91c48929cbf114ac66a6bb6db8187565fa` |
| `pre-migration-package/tests/test_full_grid_analysis.py` | `6099bcb748cc5a51a67372f0b6d484d664744eb27d8dc09cf840f02796573548` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `cf84f69945a0de7466a0e56459323758d4a7d37f05a1cc6bcec9d8258a71e3ac` |
| `pre-migration-package/full_grid_analysis.py` | `bcacbf8c8b36e0ea353e690bece38eabc8712c288b0d553a940dbf68d8a22e40` |
| `pre-migration-package/tests/test_full_grid.py` | `203ae70f86e0c89f12cac367e4b66ad6dc696d54cd6933ab3966e43eb79e8fbb` |
| `pre-migration-package/tests/test_full_grid_analysis.py` | `772d77df0f977ae2d7381d1c9e5646ad39207b57e502f1ce5c2c372a14f9abcf` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `d2e0f53ab0010609c8c9d576225caa570e4d8c9768c1b94a16af6c8b4dfb4b5b` |
| `pre-migration-package/tests/test_full_grid.py` | `39d58d27776bf8743f2d8bc094b27588fb3b4ad1aa810365dfeed61e9400bcfc` |
...
Torch 2.6.0. Lock validation passed, and a separate `uv pip check` found all
111 packages installed in the private venv compatible. A later release audit
established that these two observations did not describe one recreatable
TorchAudio resolution: the lock selected PyPI TorchAudio 2.11.0, while the
validated private venv and the sealed environment inventory contained
TorchAudio 2.6.0+cu124. After adding the canonical, read-only TCFormer
provenance helper, that installed environment passed 284 of 284 tests.

### Post-assembly, pre-release TorchAudio manifest repair

On 2026-08-10, a read-only deployment audit detected the mismatch above before
the clean release was synchronized to the empty project destination. The
release manifests were repaired for future installations by making
TorchAudio 2.6.0+cu124 a direct dependency and binding it, like Torch, to the
explicit PyTorch cu124 index:

| Path | Repaired SHA-256 |
|---|---|
| `pyproject.toml` | `17e59040701e2ad0bdf7f0cc049ac551e9b6bf56c22847e715851f2697ca50fd` |
| `uv.lock` | `739d5eae65a06a65ba69598c00c29fe8e2bcc49eed493869088b17af47a218f8` |

The repaired lock still has the same 109 package names. Its only package
version/source change is TorchAudio 2.11.0 from PyPI to
TorchAudio 2.6.0+cu124 from the cu124 index. It selects the CPython 3.12 Linux
x86-64 wheel with SHA-256
`3e5ffa69606171c74f3e2b969785ead50b782ca657e746aaee1ee7cc88dcfc08`.

This repair is prospective. It did not alter the sealed Common Grid plan,
preflight report, analysis, or result checksums. Those artifacts retain the
original `pyproject.toml` and `uv.lock` source hashes above and separately
record the actual installed TorchAudio version as `2.6.0+cu124`. Any rerun
using the repaired manifests must create a new plan and run root; it must not
be appended to or represented as the byte-identical source environment of the
sealed run.
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `c99bd94fbfd031dd5334f4241bcde70499459cc55c67b3d46e7a5989c1d8e2e0` |
| `pre-migration-package/tests/test_full_grid.py` | `283927e793412eedd0839255e3c759edeac1fba17fd4b6492e4372e23d3c3495` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `4418947a8ecf46deefd8529adaaa3977b1fa156c26aec82224fc865d1a4ad738` |
| `pre-migration-package/tests/test_full_grid.py` | `a32334338d250e7258bc636773328727e6fdf0b28b176544b534cc525aedf6ca` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `962d82e55efe6d7bd0d1ebac347c05139fe6cdeb63e239cfedff83eb1c9e1c35` |
| `pre-migration-package/tests/test_full_grid.py` | `1a6ddb9dd450b53766cec0068cedd3c0fe62f804385e0f6750bab56708631fc8` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `b1d81621e2dde8fab3fb68cf426816f2aeef8c18f98876ce6410cc73ab763f27` |
| `pre-migration-package/tests/test_full_grid.py` | `35d4c33ed5845bda09218921d146ef5cedc96331f429e87bac0a879e2791fa55` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/full_grid.py` | `5e687a5257754da301d2d42984948dc315de1f979fd1e4bd7c27c507857e67f5` |
| `pre-migration-package/tests/test_full_grid.py` | `731c82eb55bba37202da6a9e21b75f00c5c237d4517592cf2d22e8f9def9d006` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/hemiq_v2_grid.py` | `5b5519fd80069caab75767531b36cab603afd93d9baf387f3109bc519538e53c` |
| `pre-migration-package/hemiq_v2_analysis.py` | `6920d620190913d29af71e7c805743cda3f1662266ede915d1c364bc92a5dd00` |
| `pre-migration-package/tests/test_hemiq_v2_grid.py` | `8c2ad104668e4a0eab43c02d56b52adf27e477a39b808c8bf2aa9d11a3a6960b` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/hemiq_v2_grid.py` | `7813686c953fe9c9a240c6f51f29b3798c126a20e6b78b1c775fb5defc90f822` |
| `pre-migration-package/hemiq_v2_analysis.py` | `281371d7ec5a2bc38af6751fe5c3ace5ca87e617effb4761ec7adde85a64ca4b` |
| `pre-migration-package/tests/test_hemiq_v2_grid.py` | `a188608ccf402b82c44c2d734ceb4a7296f672445aa91c65edec99328a5f76af` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/hemiq_v2_grid.py` | `161854112df5f080b67df3d65ef8c8569231e6fee3019e2e3841712bb9b1b3d5` |
| `pre-migration-package/hemiq_v2_analysis.py` | `a2e8831b2206c3cd3f9c67e7cf8c064450a4d099e224cc749f866cb517ecaad8` |
| `pre-migration-package/tests/test_hemiq_v2_grid.py` | `d4a4415e386abd917d29609ba154583e06a740d2a06092472119d5ffe63f0615` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/hemiq_v2_grid.py` | `20017c6f9496770370a017ecf5196a3d97ba7ba4454082cda4be6c1528f97b90` |
| `pre-migration-package/hemiq_v2_analysis.py` | `a2e8831b2206c3cd3f9c67e7cf8c064450a4d099e224cc749f866cb517ecaad8` |
| `pre-migration-package/hemiq_v2_model.py` | `495f9c76fa8d10acb0cd1adeb1b576b2a3ed8486e981b5320550c3008fcb5a3c` |
| `pre-migration-package/tests/test_hemiq_v2_grid.py` | `8ce2ad8a64d07a81ff4e0a20678a807a8a89abeda5da92319d68d596e31d1026` |
| `pre-migration-package/tests/test_hemiq_v2_launch_envelope.py` | `7ddd791ecf514e9d95f8b0bdf75dec53d980f3b5e98f445e0896ffdd7f24c172` |
| `pre-migration-package/tests/test_hemiq_v2_model.py` | `cfc43cb09f60b7fa0cd808cab95a539fe3de05b6cc3e7b2ca9ccef41aa088eaf` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/hemiq_v2_grid.py` | `b9d357290358b7e53a453679eb81b52ae385d46d4528d51e7124ee1933e962ca` |
| `pre-migration-package/hemiq_v2_analysis.py` | `08b46b04ec93f364a05f680cb1331df186313025fffbab485ee603a3cda51e16` |
| `pre-migration-package/tests/test_hemiq_v2_grid.py` | `81cafcca0b18f3df02827f8b8dd2804ac612bdb669b48a4d3484a4b935bd4188` |
| `pre-migration-package/tests/test_hemiq_v2_launch_envelope.py` | `7ddd791ecf514e9d95f8b0bdf75dec53d980f3b5e98f445e0896ffdd7f24c172` |
| `docs/HEMIQ_V2_ADAPTER_PLAN.md` | `8cf09bf2d868b8cc7826ad33f503d1e38d1d4d767f32d714fdffa26f125bf8ae` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/gauge_quotient.py` | `7430fc0ef73630add3822816b9973bd459752e1eb08e72319b107f5cdcfc6855` |
| `pre-migration-package/gauge_quotient_screen.py` | `0a32b26b3045a9ec34865d28a5cb994f6c9442bc3b940ea5e3389df21e4acb57` |
| `pre-migration-package/tests/test_gauge_quotient.py` | `a6b7701570538cf652e411707c4829f024db3d8b179769d011541edd54884362` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/gauge_quotient.py` | `49179d934215dfe4ce6c6ecf23f6cc05acab20f32a3b3398299787141ae0599e` |
| `pre-migration-package/gauge_quotient_screen.py` | `60062362bc23180aefdb5bc26bfa735e548fc5a8a24926326e50966ce639f15c` |
| `pre-migration-package/tests/test_gauge_quotient.py` | `721de6dc180dc225eb6cad739667b6ac16b797437a963322d754c8495f3f99b1` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/gauge_gate1_runner.py` | `afd5907577de24c7b69a94a377f91fdebd1684247fe930579ab9c2b0bc14fe27` |
| `pre-migration-package/gauge_gate1_analysis.py` | `1393e04fb24f6a894ed58889810bc86ec50c42ba2eae10d090d1f9a0c8520a87` |
| `pre-migration-package/tests/test_gauge_gate1_runner.py` | `30f4da2f0617d0408992b070c5aa3f209f51c0c636f820e5a372981f786073c6` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/gauge_gate1_runner.py` | `6982601e3ef910bef6f7618bbf85e99962d21d347869512eb28af61ad36ab8bc` |
| `pre-migration-package/gauge_gate1_analysis.py` | `1393e04fb24f6a894ed58889810bc86ec50c42ba2eae10d090d1f9a0c8520a87` |
| `pre-migration-package/tests/test_gauge_gate1_runner.py` | `ea14ecfebd8970120de04141d102f323c105da4eeab620c33a3bd9321be7acd1` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/gauge_gate1_runner.py` | `7013a378445d8cbb0032effd2f868201aab3d8c4eb1ff97b399c9642bd215b45` |
| `pre-migration-package/gauge_gate1_analysis.py` | `b9dd5a1b7f281b850dedb434b63f636cd7770f4a61e40bafe74daaf918106b31` |
| `pre-migration-package/tests/test_gauge_gate1_runner.py` | `bd5d17e8b73568c00ce96ccb61c0e6f1a2701bfecd86037e63f2c4676b8928bb` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/gauge_gate1_runner.py` | `8edeb5b59122f2cd9e732141af93aee4d5dd509e363840785b16d390ef72e7ee` |
| `pre-migration-package/gauge_gate1_analysis.py` | `b9dd5a1b7f281b850dedb434b63f636cd7770f4a61e40bafe74daaf918106b31` |
| `pre-migration-package/tests/test_gauge_gate1_runner.py` | `1224e2ba82f84b154a37c4e40834cb4eb5f3bd1fbf914ad5468b86950a5f40e8` |
| `docs/GAUGE_QUOTIENT_NOVELTY_PLAN.md` | `480416dfef995083dbcac229656d47e2bb3bff53577f3f94d6040665df6a9031` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/gauge_gate1_runner.py` | `ba18f32368f6938b283c2b3c70cfa4a497baa5b6ee10de3cfdbc1c53cefd2a2d` |
| `pre-migration-package/gauge_gate1_analysis.py` | `624f01a2b5cddb992631460b6fefcfc6a312c7cace374d20b54df10b9a470b32` |
| `pre-migration-package/tests/test_gauge_gate1_runner.py` | `6bf11d877749c31deb417072481feae4d03e559e90aaec1f70eac3093c42745f` |
...
| Path | SHA-256 |
|---|---|
| `pre-migration-package/author_recipe_grid.py` | `41b7eddf9ce2fb9984a6eeb5fc7e40aff9d8b36c902494a398e2822f8e17a44b` |
| `pre-migration-package/author_recipe_analysis.py` | `e237e5deff213a6d210c6aec9010e61b9c9fd12bdeef42ab2469d1c0b97971b8` |
| `pre-migration-package/tests/test_author_recipe_grid.py` | `c3b7990422dfa25173827ca17a99f7dbe7c29ca63553f85713e24153c97a114c` |
...
## Clean release reconstruction and report QA (2026-08-10)

The clean release was synchronized non-destructively to the authorized lab
project root. Three project-private UV environments were then created from the
repaired 109-package lock with UV 0.12.0 and CPython 3.12.13: runtime, test,
and documentation. No system package was installed or changed. The runtime
import gate observed Torch 2.6.0+cu124, TorchAudio 2.6.0+cu124, CUDA build
12.4, four available CUDA devices, and compatible Braindecode/MOABB imports.

Clean-build QA exposed and repaired two release defects before handoff:

1. the transitive TorchAudio mismatch documented in the preceding repair
   section; and
2. backend-dependent few-ulp accumulation when HemiQ filtered physically
   swapped channels in different flattened-batch slots. HemiQ now filters the
   canonical even/centre/odd basis and algebraically reconstructs C3/C4
   coefficients, preserving the same linear Gabor representation and passing
   all 11 exact reflection tests on the reviewed Torch 2.6 backend.

The final frozen suite completed with **1,373 passed, 0 failed**, 179 warnings,
in 205.90 seconds. The warnings were expected library/filter notices,
deliberately malformed duplicate-ZIP fixtures, and a Linux multiprocessing
fork deprecation notice; none was a failed assertion. Both the whole-release
verifier and the protocol-separated results-bundle verifier passed after the
test-only Python/Pytest caches were removed.

The documentation environment generated each report twice with identical
bytes:

| Report | Pages | SHA-256 |
|---|---:|---|
| `Benchmark_Results_and_Statistics.pdf` | 11 | `8877a23e27edc599e7241725d510ab5352e4b3d0a307dc8700d07c3fd47bed42` |
| `Methodology_and_Architectures.pdf` | 7 | `959b22c8302a4c5c614d5ed743a28ae0423bb94d7a579d97223c85fbb72f019c` |
| `Reproducibility_Handbook.pdf` | 12 | `3c1aa0d723715f8113cd0491da6dd0479ed2b0942afe8f440b438aef9725ab78` |

All 30 pages were rendered with Poppler and inspected. No blank or orphan
page, clipped content, overlap, or unreadable table was observed. Pypdf and
pdfplumber independently confirmed the page counts, page sizes, encryption
state, required text, and nonempty text extraction on every page. The final
lab filesystem retained 66,611,572,736 bytes free, above the 50-GiB reserve.
No sealed plan, audit, result, or analysis byte changed during this clean
release reconstruction.

## Full-model chart report revision (2026-08-19)

At the user's request, the benchmark report was regenerated with two dedicated
landscape pages that chart every one of the 43 common-grid configurations. One
page presents the primary equal-dataset macro balanced-accuracy ranking; the
other presents the independently ordered descriptive standard-accuracy
ranking. Both charts use an absolute 0%-80% axis, print each exact
three-decimal percentage, distinguish the 15 external common configurations
from project configurations, and retain the complete numeric tables.

The protocol-separated results bundle passed checksum and boundary
verification before generation. The benchmark PDF was built twice with
identical bytes:

| Report | Pages | SHA-256 |
|---|---:|---|
| `Benchmark_Results_and_Statistics.pdf` | 13 | `085a7bb97d27666b7d62650f76aa5262db5286b01e7f2d0b4162376893671b95` |

All 13 benchmark pages were rendered with Poppler at 180 dpi and inspected.
The two chart pages each contained 43 unique model labels, ranks 1-43, and all
43 source-matched values. Pypdf confirmed the page count, landscape Letter
geometry, table-of-contents destinations, independent metric ordering, and
nonempty text extraction. No clipping, overlap, missing row, or unreadable
label was observed. The methodology and reproducibility PDFs remained
byte-identical to the hashes recorded above. This was a presentation-only
revision: no sealed plan, audit, result, analysis, score, or ranking changed.
A scoped `.gitattributes` rule now preserves the canonical CRLF serialization
of the checksummed analysis CSVs, and the generated PDFs, byte-for-byte across
Git checkouts.

## Package boundary and reproducibility-identity hardening (2026-08-19)

At the time of this entry, the release layout was clarified without moving
either Python package. The then-current decision kept the predecessor package
as the formal common-grid namespace because its module paths and first-party
source hashes were embedded in the completed plan. That implementation
decision was later superseded by the public namespace migration and sanitized
metadata reissue. In this public ledger, `pre-migration-package/` displays
those old path positions without pretending they are current paths.
`deepnet/` remains a compatibility/support namespace for auxiliary procedures,
tests, and full-release provenance; it is not imported by the sealed
common-grid v6 scientific source closure. `docs/PROJECT_STRUCTURE.md` records
the boundary and the migration rule for any future consolidated namespace.

The immutable randomization contract remains five training seeds - 7, 17, 27,
37, and 47 - for all 96,320 jobs. It was not collapsed to one seed. The
analysis separately retains bootstrap seed 20260729 and 100,000 resamples.
Common-grid v6 did not record `PYTHONHASHSEED`, so no retroactive execution
setting was added.

The new read-only `scripts/reproduce.sh identity` command uses isolated,
site-disabled, bytecode-disabled standard Python. It now:

- recomputes the canonical plan digest and checks `plan.sha256`;
- checks the exact five-seed roster, training-template seed, grid dimensions,
  96,320-job count, bootstrap seed, and resample count;
- checks the recorded plan and first-party source cuBLAS workspace contract;
- hashes the nine formal first-party execution files, the analysis source,
  five vendored TCFormer runtime files, and the TCFormer source manifest; and
- requires exactly the three publication PDFs plus their checksum ledger and
  validates every report hash.

The portable `scripts/reproduce.sh verify` command runs both the whole-release
and protocol-separated results verifiers without creating a UV environment.
Both Python processes use `-I -B -S`; hostile `PYTHONPATH` and `PYTHONHOME`
values were ignored in replay. The whole-release verifier now validates every
pre-release repair transition and final repaired-file hash, hard-pins the
identity checker before exact-path loading, and can be invoked twice directly
without creating a forbidden `__pycache__`.

Both verifiers passed. The report builder then regenerated all three PDFs
twice. Their hashes remained exactly:

- Benchmark: `085a7bb97d27666b7d62650f76aa5262db5286b01e7f2d0b4162376893671b95`;
- Methodology: `959b22c8302a4c5c614d5ed743a28ae0423bb94d7a579d97223c85fbb72f019c`;
  and
- Handbook: `3c1aa0d723715f8113cd0491da6dd0479ed2b0942afe8f440b438aef9725ab78`.

All 32 final pages were rendered and inspected without clipping, overlap,
missing content, or pagination defects. No sealed plan, audit, result,
analysis, score, ranking, training algorithm, or historical execution
environment was modified.

## Bounded reviewer replay validation (2026-08-19)

The single-GPU reviewer workflow completed one full public dataset cell:
`cardinal_fbc_compactdyn_scale025_extended` on `bnci2014_004`. The immutable
selection contained 45 jobs. Final status was 45 complete and zero missing,
invalid, extra, partial, quarantined, or unsafe entries; all 45 replay
prediction hashes exactly matched the sealed prediction hashes.

Replayed accuracy and balanced accuracy were both
`0.7792361111111111`, equal to the sealed values with absolute delta zero.
The comparison reported `strict_score_match=true`,
`paper_display_match=true`, and `bit_exact_prediction_match=true`. The summed
recorded job time was `408.60359093360603` seconds and the completed run tree
occupied 612 KiB.

Runtime validation compared the complete 102-package release closure with the
102 installed packages. It found no missing, extra, or version-drifted package
and reported `release_locked_stack_match=true`.
`exact_execution_identity_match=false` solely because `pyproject.toml` and
`uv.lock` carry the documented repaired release source identities rather than
the byte identities sealed in the original formal plan. The outcome is a
successful fixed-protocol replication; it does not relabel repaired manifests
as the original execution identity.

| Bound artifact | SHA-256 |
|---|---|
| Replay-plan identity | `2bdc42246540dee93a7f736c371ddd308c4dd78039ae21c5c5cb4c9b16eefb9b` |
| `replay_plan.json` | `45a179cd43ea837086ae9b13072a0f44d1da9ac7cf16373c6982651f47014b11` |
| `environment.json` | `b388994d48db035394b0815b0d5369dd101735f062bc55d21aef813bcd0009df` |
| `comparison.json` | `47b0f1b8bcde245047ed1638e752c24a8ee430ef181d167bbe5666b251a48294` |

Private host paths and physical GPU identifiers are intentionally omitted.
No formal plan, sealed result, analysis score, ranking, or publication PDF was
modified by this validation.

## Public package namespace migration (2026-08-19)

The sole active package was renamed from the predecessor namespace to
`eeg_mi`, and the active distribution became `benchmark`. No top-level
compatibility package exposes the retired import. At this intermediate stage,
an exact formal v6 source snapshot and its manifests were preserved for the
isolated reviewer adapter; the later public cleanup replaced that copy with a
sanitized, checksummed source reissue.

At this intermediate stage, the migration did not rewrite the completed v6
plan, source-hash map, executor string, or results. The later public reissue
does rewrite namespace-bearing metadata while preserving the scientific
tables and numeric result values. Its predecessor hashes are lineage only,
not current execution identity. The supported bounded v6 verification path is
`scripts/reproduce.sh reviewer`; ordinary current module commands and tests
use `eeg_mi`.

## Namespace-migration release validation (2026-08-19)

The migration was completed and tested on the lab workstation. The deployed
project had no top-level predecessor package or root-level formal-grid test;
`eeg_mi` was the only active benchmark import and the retired import failed
both before and after importing reviewer replay. The retired package and
runtime lease artifacts were moved to a recoverable external scratch backup,
not deleted. Historical source under `historical/` remained non-importable by
ordinary project code.

The active dependency manifests are:

| Manifest | SHA-256 |
|---|---|
| `pyproject.toml` | `44ad339204db45dddb890653b7a76eb1d28ae7d91c28ba6a4603e0d20d21ca26` |
| `uv.lock` | `2c4dd260d457396ffddd55759aeaceb8224d65beafd1f6dc6df9e60c6a7e4ade` |

The complete migrated `eeg_mi` suite passed **1,134 tests** with zero failures
and 176 expected warnings in 218.68 seconds. The final reviewer replay module
passed 30/30 tests, the native-FBMS focused suite passed 87/87, and the
post-freeze track-matrix plus reviewer regression passed 42/42. The matrix now
correctly labels the five retired native-FBMS writer configurations as blocked
historical procedures rather than runnable adapters.

The actual frozen native-FBMS checkpoint passed the migrated reader under the
release Torch 2.6/cu124 stack. Its exact file SHA begins `7378450e`, loaded
state SHA begins `e045e8c1`, and independently pinned writer-host initial-state
SHA begins `382d4e18`. The reader no longer attempts to regenerate that initial
state under a different Torch RNG implementation; exact checkpoint bytes,
schema, archived 11-file source manifest, class/architecture, strict state-dict
load, checkpoint-state digest, corpus, partition, and configuration remain
mandatory. Real completed screen and full-grid native records also passed
their migrated audits.

The pre-migration 45-job reviewer root remained readable but non-resumable.
Status reported 45/45 complete with zero invalid, missing, extra, partial,
quarantined, or unsafe entries. Recomputed standard and balanced accuracy were
both `0.7792361111111111`; strict, displayed, and all 45 prediction-digest
comparisons matched the sealed evidence exactly.

A fresh post-migration v2 smoke replay then executed exactly one job:
`cardinal_fbc_compactdyn_scale025_extended`, BNCI2014-004 participant 1,
fold 0, seed 7. It did not launch the complete grid. Status was 1/1 complete
with no invalid or unexpected artifacts. Replayed standard and balanced
accuracy were both `0.740625`, absolute delta zero from the sealed job row;
the prediction digest was bit-exact. New artifacts use only the
`eeg-mi-reviewer-replay-...-v2` schemas.

| Bound v2 artifact | SHA-256 |
|---|---|
| Replay-plan identity | `5c9c15f0524b0f35dc76f40da8a4b83ccb0cda9b9b41066b3bbc99bb484a8f74` |
| `replay_plan.json` | `1ddebe2db566297873007c2b93d507fc88d2410936c13a2709fc5a78d1be0226` |
| `environment.json` | `916baca4257405be817c8b60aa6448b250bfd2eb19de45b7ecb8bffece9c7bbf` |
| `comparison.json` | `58739ec98623853333291d9d3917669c072c896b29804a13e5a03c5502dccaec` |

The v2 runtime matched all 102 locked packages, Python, Torch/CUDA, UV, and
the supported Linux platform. `exact_execution_identity_match=false` remains
correct because the active namespace is a documented post-publication source
identity, not the byte identity embedded in v6. This does not prevent the
strict score and bit-exact prediction comparisons from being reported
separately.

Both local and deployed release verifiers passed, as did the independent
results-bundle verifier. The sealed results ledger remains
`059710591fb9a5c444a6e79082c291659439b9b1f718596cda23d33966a4ee1e`.
The current 13-page benchmark, 7-page methodology, and 12-page handbook PDFs
have SHA-256 values
`085a7bb97d27666b7d62650f76aa5262db5286b01e7f2d0b4162376893671b95`,
`b2e2669dd95163271d484e5ecc6047ec4c7c9838cd7ce90e8d683cb7214704a0`,
and `3c1aa0d723715f8113cd0491da6dd0479ed2b0942afe8f440b438aef9725ab78`;
all 32 pages were rendered and inspected without clipping, overlap, or missing
content. No result score, rank, sealed plan, or analysis artifact changed.

## Reviewer score-cell catalog validation (2026-08-19)

The release now includes a deterministic 258-row CSV catalog covering all 43
models on the five individual datasets plus the equal-dataset overall target.
Each row carries both standard and balanced accuracy, so the file binds all
516 numeric cells in the two complete paper-facing score tables to a bounded
reviewer replay. Only the 43 model-scope rows are marked as recommended for a
complete-table rerun; together they cover the original 96,320 jobs without
duplicating the dataset scopes.

The catalog has 51 fixed columns and SHA-256
`a8bb0e9b93773171b272d210968eacb7006cb0668afd226dd04acd3357eb2876`.
Its generator authenticates the plan, final audit, analysis manifest, dataset
and overall score authorities, ranking table, and 96,320-row timing table
before emitting any row. `scripts/reproduce.sh reviewer catalog --check`
regenerated the catalog in memory and matched every distributed byte locally
and on the lab workstation.

The focused catalog suite passed **9/9 tests** on the locked lab environment
in 5.96 seconds. It checks exact roster/order/cardinality, full-precision score
lineage, rank and display context, dataset dimensions, historical timing sums,
data-access flags, shell-tokenized command selectors, fail-closed placeholders,
authority tamper rejection, atomic output, and stale-file detection. The whole
release and independent results-bundle verifiers also passed after catalog
integration.

A representative command copied from the BNCI2014-004 leader row returned 45
jobs and `0.11571915721882962` historical summed A5000 hours, matching the CSV
value after its documented 12-decimal formatting. No training was launched by
that read-only estimate. Spreadsheet-tool import independently confirmed the
259-by-51 header-plus-data shape, 258 unique score-cell IDs, exactly 43
recommended model rows, and no spreadsheet formula-error tokens.

The catalog adds no score, rank, prediction, or trial data. It copies the
sealed full-precision accuracy values and records their source hashes. It is
outside `results/`, whose checksum closure remains unchanged.

## Local source-layer consolidation (2026-08-19)

After the lab validations above, the local release source was reorganized into
one `benchmark` namespace with `benchmark`, `research`, and `shared`
layers and a mirrored top-level `tests` tree. This was a source-organization
change only: no cluster command was run and no completed scientific score
table was changed. Earlier test counts remain historical evidence for the
source identity tested at that time, not a claim that the reorganized tree was
executed on the lab workstation.
...
4. record the user/institution decisions for licensing, authorship/CITATION,
