...
No label is opened until :mod:`benchmark.author_recipe_grid` proves that the
...
ANALYSIS_SCHEMA = "eeg-mi-author-recipe-analysis-v1"
MANIFEST_SCHEMA = "eeg-mi-author-recipe-analysis-manifest-v1"
PUBLICATION_LOCK_SCHEMA = "eeg-mi-author-recipe-analysis-lock-v1"
...
def decision_contract() -> dict[str, Any]:
    ...
    return {
        "schema": "eeg-mi-author-recipe-analysis-decisions-v1",
        "track": TRACK,
...
def _analysis_source_identity() -> dict[str, str]:
    return {
        "src/benchmark/author_recipe_analysis.py": _sha256_file(
