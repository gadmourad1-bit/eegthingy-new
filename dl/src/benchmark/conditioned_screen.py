...
RECORD_SCHEMA = "eeg-mi-chsd-conditioned-validation-record-v3"
STATUS_SCHEMA = "eeg-mi-chsd-conditioned-screen-status-v3"
SEED = 7
WORKER_COUNT = 3
CPU_THREADS = 4
...
MODEL_FACTORY = "benchmark.chsd_conditioned:make_chsd_conditioned_model"
