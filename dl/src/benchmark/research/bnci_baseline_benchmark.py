...
This runner is the matched reference for :mod:`benchmark.research.parity_benchmark`.  It
...
Example development run::
    ...
    python -m benchmark.research.bnci_baseline_benchmark \
        --mode bnci-dev --device cuda \
        --output src/benchmark/research/results/parity/bnci_fixed_baselines_dev.json
...
BASELINE_CONTRACTS: dict[str, dict[str, Any]] = {
    "shallow_swap": {
        ...
        "implementation": "benchmark.research.dnn_baselines.TorchEEGClassifier[shallow]",
        "input": "broadband",
        "fit_split": "train",
    ...
    "riemann": {
        ...
        "implementation": "benchmark.research.baselines.RiemannianTangentLogistic",
        "input": "covariances",
        "fit_split": "train",
    ...
    "tangent_anchor": {
        ...
        "implementation": "benchmark.research.tangent_anchor.TangentAnchorClassifier",
        "input": "covariances",
        "fit_split": "train",
        "validation_role": "unused_fixed_estimator",
