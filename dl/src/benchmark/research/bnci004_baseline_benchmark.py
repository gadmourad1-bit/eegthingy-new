...
BASELINE_CONTRACTS: dict[str, dict[str, Any]] = {
    ...
    "fb_csp_lda": {
        ...
        "implementation": "benchmark.research.bnci004_baseline_benchmark.ShrinkageFilterBankCSPLDA",
        "input": "four-band covariances",
        "channels": list(BNCI_CHANNELS),
        "reference": "provided_bipolar",
        "fit_sessions": list(FIT_SESSIONS),
...
_SOURCE_FILES = (
    ...
    "src/benchmark/research/bnci004_baseline_benchmark.py",
    "src/benchmark/research/external_bnci2014_004.py",
