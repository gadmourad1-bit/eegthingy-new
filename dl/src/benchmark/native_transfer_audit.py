...
format emitted by :mod:`benchmark.native_transfer` and computes descriptive
...
AUDIT_SCHEMA = "eeg-mi-native-transfer-development-audit-v1"
SUMMARY_SCHEMA = "eeg-mi-native-transfer-development-descriptive-summary-v1"
