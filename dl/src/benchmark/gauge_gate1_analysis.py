...
applies only the frozen rule from :mod:`benchmark.gauge_quotient_screen`.
...
ANALYSIS_SCHEMA: Final = "eeg-mi-gauge-gate1-decision-v1"
ANALYSIS_DIRECTORY: Final = "analysis_gate1"
ANALYSIS_MARKER: Final = b"eeg-mi-gauge-gate1-analysis-committed-v1\n"
