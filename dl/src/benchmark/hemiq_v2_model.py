...
from benchmark.research.cameo_net import FrozenTangentAnchor, _mirror_covariances
from benchmark.research.data import make_spd_covariances
from benchmark.research.hemi_q_field_net import (
    HEMI_Q_CHANNELS,
    HemiQFieldConfig,
    HemiQFieldNet,
)
...
CONFIG_SCHEMA = "eeg-mi-hemiq-harmonized-v2-config-v1"
VIEW_SCHEMA = "eeg-mi-hemiq-harmonized-v2-views-v1"
CONFIG_RELATIVE_PATH = "configs/hemiq/hemiq_field_harmonized_v2.json"
CONFIG_SIZE_BYTES = 1059
CONFIG_SHA256 = "fa30acf45271e64eb9f9497a44aeb3ffd6d165beace733f55d5c950c0770ba65"
...
def hemiq_view_contract(sfreq: float = EXPECTED_SFREQ) -> dict[str, Any]:
    ...
    return {
        "schema": VIEW_SCHEMA,
        "input": "unaltered harmonized eeg-mi-cache-v2 BNCI2014-004 trial",
