# EEG-MI development ledger

> **Sanitized chronological record.** Paths and artifact prefixes in this
> ledger use the current neutral project naming. Historical machine locations
> are documentary only; supported commands are defined by the release scripts.
...
GPU source snapshot:
`/home/user/Desktop/eegthingy_eeg_arch_20260719`
...
GPU source snapshot:
`/home/user/Desktop/eegthingy_eeg_arch_v6_20260719`
...
The complete local `eeg_mi/tests` suite passed 312 tests before remote sync.
