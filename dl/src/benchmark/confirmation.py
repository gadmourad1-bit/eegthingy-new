...
CONFIRMATION_STARTED_SCHEMA = "eeg-mi-confirmation-started-v1"
CONFIRMATION_PREDICTION_SCHEMA = "eeg-mi-confirmation-prediction-v1"
CONFIRMATION_COMPLETED_SCHEMA = "eeg-mi-confirmation-predictions-complete-v1"
CONFIRMATION_SCORING_STARTED_SCHEMA = "eeg-mi-confirmation-scoring-started-v1"
CONFIRMATION_SCORE_SCHEMA = "eeg-mi-confirmation-score-v1"
...
def _compute_frozen_primary_statistic(
    ...
    details = {
        "schema": "eeg-mi-primary-statistic-details-v1",
...
def _validate_primary_statistic_details(
    ...
    *,
    ...
    if (
        ...
        or details.get("schema") != "eeg-mi-primary-statistic-details-v1"
