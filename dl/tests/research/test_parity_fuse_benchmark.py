...
import benchmark.research.parity_fuse_benchmark as benchmark
from benchmark.research.parity_fuse_net import ParityFuseConfig, ParityFuseOutput
...
def test_write_and_validate_frozen_manifest_pins_dev_file_and_summary(
    ...
    source = {"src/benchmark/research/parity_fuse_net.py": "1" * 64}
