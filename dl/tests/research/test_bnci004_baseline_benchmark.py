...
import benchmark.research.bnci004_baseline_benchmark as benchmark
...
def test_shallow_fits_train_and_uses_validation_only_for_checkpoint(
    ...
    from benchmark.research import dnn_baselines
...
def test_riemann_never_calibrates_or_fits_on_outer_test(
    ...
    from benchmark.research import baselines
...
def test_tangent_anchor_learns_reference_and_scaler_from_train_only(
    ...
    from benchmark.research import tangent_anchor
...
def _freeze_contract(
    ...
    source = {"src/benchmark/research/synthetic.py": "b" * 64}
