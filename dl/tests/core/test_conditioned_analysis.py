...
import benchmark.conditioned_screen as conditioned_screen
from benchmark.conditioned_analysis import (
    ConditionedAnalysisError,
    analyze_run,
    write_analysis_bundle,
)
from benchmark.conditioned_screen import (
    CONDITIONED_MODELS,
    REFERENCE_MODELS,
    SOURCE_FILES,
    ScreenJob,
...
def _complete_runs(
    ...
    reference_plan = assemble_reference_manifest(
        ...
        source_hashes={"src/benchmark/development_screen.py": _digest("reference")},
...
def test_tied_or_failed_gate_kills_family() -> None:
    from benchmark.conditioned_analysis import _decision
