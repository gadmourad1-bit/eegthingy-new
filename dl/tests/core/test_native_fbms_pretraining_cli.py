...
from benchmark import native_fbms_pretraining_cli as cli
from benchmark import native_fbms_transfer as transfer
from benchmark import native_pretraining_cli as core_cli
...
def test_fbms_cli_refuses_to_misattribute_active_code_to_v1(
    tmp_path,
) -> None:
