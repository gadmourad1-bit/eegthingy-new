...
from benchmark import hemiq_v2_analysis as analysis
...
def _valid_plan() -> dict:
    ...
    for subject in grid.SUBJECTS:
        ...
        cache_identity[key] = {
            "archive": {
                "relative_path": (
                    f"eeg-mi-cache-v2/harmonized/{grid.DATASET}/"
