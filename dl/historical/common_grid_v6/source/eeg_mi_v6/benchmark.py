...
DEVELOPMENT_ARTIFACT_SCHEMA = "eeg-mi-development-v4"
LEGACY_SCREEN_ARTIFACT_SCHEMA = "eeg-mi-development-v3"
...
def _architecture_identity(model: torch.nn.Module, requested_name: str) -> dict[str, Any]:
    ...
    provenance = getattr(type(target), "_eeg_provenance", None)
