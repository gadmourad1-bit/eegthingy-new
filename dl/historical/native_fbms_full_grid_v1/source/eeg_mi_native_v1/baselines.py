...
def _official_tcformer_module() -> type[nn.Module]:
    ...
    _load_module_from_path(
        "_eeg_tcformer.models.modules", root / "models" / "modules.py"
    )
    _load_module_from_path(
    ...
    try:
        ...
        module = _load_module_from_path(
            "_eeg_tcformer.models.tcformer", root / "models" / "tcformer.py"
        )
    finally:
    ...
    module.TCFormerModule._eeg_provenance = {  # type: ignore[attr-defined]
        "repository": str(root),
        "commit": commit,
        "tracked_dirty": False,
    }
