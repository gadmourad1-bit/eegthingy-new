...
Only already-opened `ieee-mi-cache-v2/harmonized` development caches are
...
export IEEE_MI_TCFORMER_ROOT=/home/hanafy/scratchpad/eeg_novel_20260729/source/third_party/TCFormer
...
```bash
uv run --active --no-sync python -m ieee_mi.robustness_screen plan \
...
```bash
CUDA_VISIBLE_DEVICES=GPU-UUID-0 uv run --active --no-sync python -m ieee_mi.robustness_screen worker \
  --run-root /home/hanafy/scratchpad/eeg_novel_20260729/runs/chsd_disjoint_robustness_v1 \
  --cache-root /home/hanafy/scratchpad/eeg_novel_20260729/data_cache \
...
```bash
uv run --active --no-sync python -m ieee_mi.robustness_screen status \
  --run-root /home/hanafy/scratchpad/eeg_novel_20260729/runs/chsd_disjoint_robustness_v1
```
...
```bash
uv run --active --no-sync python -m ieee_mi.robustness_analysis \
  --run-root /home/hanafy/scratchpad/eeg_novel_20260729/runs/chsd_disjoint_robustness_v1 \
