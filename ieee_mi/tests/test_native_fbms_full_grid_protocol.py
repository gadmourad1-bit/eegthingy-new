...
from ieee_mi import native_fbms_full_grid_audit as audit
from ieee_mi import native_fbms_full_grid_gate as gate
from ieee_mi import native_fbms_transfer as transfer
from ieee_mi import native_fbms_transfer_audit as screen_audit
...
def _record(key: core.TransferRecordKey) -> core.ValidatedTransferArtifact:
    ...
    return core.ValidatedTransferArtifact(
        ...
        source_code_hashes=(("ieee_mi/native_fbms_transfer.py", _digest("source")),),
        test_rows=rows,
        test_labels=labels,
