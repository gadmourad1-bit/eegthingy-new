...
from ieee_mi import full_grid, project_gpu_leases
...
def tiny_plan(
    *,
    ...
    cache = {"toy:s001": {"array_sha256": "a" * 64}}
    split = {
        "toy:s001:f00": {
            "dataset": "toy",
            "subject": 1,
...
def test_preflight_enumerates_exact_43_times_four(
    ...
    monkeypatch.setattr(
        full_grid,
        "_source_identity",
        lambda **unused: {"ieee_mi/full_grid.py": "a" * 64},
    )
...
def test_cache_open_rejects_aliases_before_numpy(
    ...
    from ieee_mi.config import DEFAULT_MONTAGE_PROFILE
    from ieee_mi.data import _cache_path
...
def test_formal_tcformer_metadata_requires_exact_pinned_provenance() -> None:
    ...
    observed["fit"]["architecture"] = {
        ...
        "class": "_ieee_tcformer.models.tcformer.TCFormerModule",
        "wrapped_class": "_ieee_tcformer.models.tcformer.TCFormerModule",
        "scalar_attributes": {},
    }
