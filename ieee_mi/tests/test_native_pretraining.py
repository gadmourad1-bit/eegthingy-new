...
from ieee_mi.config import DATASETS, PREPROCESSING
from ieee_mi.data import fit_channel_scaler
from ieee_mi.models import CANONICAL_21_POSITIONS, CardinalFBMSNet, CardinalFBCNet
from ieee_mi import native_pretraining
...
def test_locked_native_cache_loader_filters_scales_and_records_provenance(
    ...
    assert corpus.cache_schema == "ieee-mi-cache-v2"
...
def test_locked_native_loader_requires_v2_schema_before_io(
    ...
    monkeypatch.setitem(PREPROCESSING, "schema", "ieee-mi-cache-v1")
