"""Fail-closed post-hoc analysis for :mod:`ieee_mi.full_grid`.
...
ANALYSIS_SCHEMA = "ieee-mi-common-grid-analysis-v4"
MANIFEST_SCHEMA = "ieee-mi-common-grid-analysis-manifest-v4"
    ...
    try:
        try:
            full_grid._write_bytes_exclusive_at(
                parent_descriptor,
                fence_name,
                b"ieee-mi-common-analysis-output-fence-v1\n",
            )
