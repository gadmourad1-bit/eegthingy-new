...
AUDIT_SCHEMA = "ieee-mi-native-cardinal-fbms-full-grid-audit-v1"
SUMMARY_SCHEMA = "ieee-mi-native-cardinal-fbms-full-grid-summary-v1"
GRID_SCHEMA = "ieee-mi-native-cardinal-fbms-full-development-grid-v1"
...
PINNED_SOURCE_MANIFEST = {
    "ieee_mi/baselines.py": (
        "93d47e09cb995cb7d2b40555df9ca619ce87867c8d8761de4867fd5a12ab4b21"
    ),
    "ieee_mi/config.py": (
        "e48773f0cd82f85faf6a2df3d733b5a8e2eb9862db6bf77bbff974b8da53b69a"
    ),
    "ieee_mi/data.py": (
        "4e8bcb88df237acb2b622ff3ea46413448759f2f4058fc299f8f6801c24b82da"
    ),
    "ieee_mi/models.py": (
        "b4df65012d1df9f8979207dd28518ead0a396cd3ddae215a87cbf95e21534400"
    ),
    "ieee_mi/native_fbms_pretraining_cli.py": (
        "2b531d7739b27af3f11a102243552074e8334ee9a6e11854f4fec0bc434bda44"
    ),
    "ieee_mi/native_fbms_transfer.py": PINNED_TRANSFER_SOURCE_SHA256,
    "ieee_mi/native_pretraining.py": (
        "189976fbf682b46ce78c7b9644f3fe381638b15228eabf970a66766cb2ab8214"
    ),
    "ieee_mi/native_pretraining_cli.py": (
        "296bc0ae38190a05292166791074445a2bb7ace9ddf5eb89fc914094af76a16b"
    ),
    "ieee_mi/native_transfer.py": (
        "76745572a9f40fe9c81329563920eab6404c8647b1c21d1b85ac29c6494531c0"
    ),
    "ieee_mi/requirements-cu128.txt": (
...
PINNED_SOURCE_MANIFEST_SHA256 = (
    "766fd7f3406a1f3106d85e5f1725b78d2cf00f63fda0080c272a7c19e1119d8a"
)
...
PINNED_EXECUTION_ENVIRONMENT = {
    ...
    "python": "3.12.3",
    "python_executable": (
        "/home/user/Desktop/eegthingy_ieee_arch_v7_20260719/.venv/bin/python"
    ),
...
PINNED_EXECUTION_ENVIRONMENT_SHA256 = (
    "f9c785350335403f70fc7e023596869f1d0d22d8adbac8f898124c1bc9df7ca1"
)
