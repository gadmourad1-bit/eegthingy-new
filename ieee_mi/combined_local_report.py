...
SCHEMA = "ieee-mi-combined-local-report-v1"
NEURAL_SCHEMA = "ieee-mi-local-model-tournament-result-v1"
NEURAL_ARTIFACT_SCHEMA = "ieee-mi-development-v4"
GEOMETRIC_SCHEMA = "ieee-mi-local-geometric-controls-v1"
