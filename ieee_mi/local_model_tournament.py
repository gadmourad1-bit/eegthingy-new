...
can be trained by :mod:`ieee_mi.benchmark` under one common recipe.  Training
...
PLAN_SCHEMA = "ieee-mi-local-model-tournament-plan-v1"
RESULT_SCHEMA = "ieee-mi-local-model-tournament-result-v1"
DATASET = "local_exp4"
...
def _preflight(args: argparse.Namespace) -> int:
    ...
    payload = {
        "schema": "ieee-mi-local-model-tournament-preflight-v1",
        "created_at": _utc_now(),
        "dataset": DATASET,
        "device": str(device),
        "models": list(models),
