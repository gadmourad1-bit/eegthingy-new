...
ARTIFACT_SCHEMA = "ieee-mi-native-cardinal-fbms-pretraining-development-v1"
CHECKPOINT_SCHEMA = "ieee-mi-native-cardinal-fbms-pretraining-checkpoint-v1"
...
ENTRY_POINT = _core.NativePretrainingEntryPoint(
    ...
    extra_source_files=(("ieee_mi/native_fbms_pretraining_cli.py", Path(__file__)),),
)
