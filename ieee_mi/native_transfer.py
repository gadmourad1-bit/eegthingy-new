...
ARTIFACT_SCHEMA = "ieee-mi-native-transfer-development-v1"
PREDICTION_SCHEMA = "ieee-mi-native-transfer-predictions-v1"
...
def _source_paths() -> dict[str, Path]:
    ...
    paths = {
        "ieee_mi/baselines.py": package / "baselines.py",
        "ieee_mi/config.py": package / "config.py",
        "ieee_mi/data.py": package / "data.py",
        "ieee_mi/models.py": package / "models.py",
        "ieee_mi/native_pretraining.py": package / "native_pretraining.py",
        "ieee_mi/native_pretraining_cli.py": package / "native_pretraining_cli.py",
        "ieee_mi/native_transfer.py": Path(__file__).resolve(),
        "ieee_mi/training.py": package / "training.py",
        "ieee_mi/requirements-cu128.txt": package / "requirements-cu128.txt",
    }
