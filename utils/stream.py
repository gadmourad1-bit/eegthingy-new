...
from config import EEG_CHANNELS_MAPPING, LABELS, PHASES
...
class Stream:
    ...
    def start(self):
        ...
        def worker():
            ...
            print(
                f"Stream stopped: misc={count/elapsed:.2f}Hz, "
    ...
    def save(self, filename, params=None):
        ...
        ch_types = ["eeg"] * 16 + ["misc"] * 3 + ["emg"] * 4 + ["misc"] * 2 + ["misc"]
        ...
        print(
            f"Stream saved {raw.n_times} samples, "
